...
def main():
    ...
    # ---- orders ----
        # order_purchase_timestamp in the landing data is "dd-MM-yyyy HH:mm"
        # (e.g. "11-09-2018 08:53"), not the ISO format Olist's original CSVs use.
        ...
        orders = orders.withColumn(
            "order_date", F.to_date("order_purchase_timestamp", "dd-MM-yyyy HH:mm")
        )
